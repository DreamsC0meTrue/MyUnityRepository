...
//2.스크립트가 연결된 상태라면 그 오브젝트는 대상의 컴포넌트를 제거할 수 없습니다.
...
public class PlayerMovement : MonoBehaviour
{
    ...
    public float speed = 2.0f; //소수점을 적을 떄는 마지막에 f 기호를 사용합니다.
    ...
    private void Move()
    {
        ...
        //Horizontal : 수평 이동 a,d키나 키보드의 왼쪽, 오른쪽 키
        //Vertical : 수직 이동 w,s 키나 키보드의 위, 아래키
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        //충돌체의 게임 오브젝트의 레이어가 7과 비교했을 떄 크기가 같다면
